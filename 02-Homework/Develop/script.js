...
function generatePassword() {
  ...
  // Array to contain one of each chosen character so each will be used.
  var guaranteedChar = [];

  // Conditional statements that add array of each character into array of possible characters based on user input and pushes new random character to guaranteedCharacters.
  ...
  // For loop to iterate over the password length from the options object, selecting random indices from the array possible.
  var randomChar = [];
